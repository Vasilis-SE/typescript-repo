...
function () {
  ...
  Person.prototype.setBalance = function (bal) {
    this.balance = bal;
  };
...
/** @class */
function (_super) {
  __extends(Employee2, _super); // Constructor
  ...
  Employee2.prototype.getEmployeeId = function () {
    return this.id;
  };

  Employee2.prototype.setEmployeeId = function (id) {
    this.id = id;
  };
